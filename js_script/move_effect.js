...
// Z変化技の効果
exports.Zstatus = function(){
    return Z_status_move
}
var Z_status_move = [
...
// キョダイマックス可能なポケモン
exports.gigadyna = function(){
    return gigadynamax_move
}
var gigadynamax_move = [
    ['フシギバナ', 'キョダイベンタツ', 'くさ'], 
    ['リザードン', 'キョダイゴクエン', 'ほのお'], 
    ['カメックス', 'キョダイホウゲキ', 'みず'], 
    ['バタフリー', 'キョダイコワク', 'むし'], 
...
exports.dynaPow = function(){
    return dynamax_move_power
}
var dynamax_move_power = [
    ['マルチアタック', '95'], 
    ['アシストパワー', '130'], 
    ['つけあがる', '130'], 
    ['ウェザーボール', '130'], 
